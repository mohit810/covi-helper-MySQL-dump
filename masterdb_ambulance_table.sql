...
DROP TABLE IF EXISTS `ambulance_table`;
...
LOCK TABLES `ambulance_table` WRITE;
/*!40000 ALTER TABLE `ambulance_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `ambulance_table` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-08-01 16:12:19
